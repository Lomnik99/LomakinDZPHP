...
<body class="min-h-screen bg-gray-50 text-gray-900 font-inter antialiased">
...
<header class="bg-white border-b border-gray-200 sticky top-0 z-50 shadow-sm">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-16">
            ...
            <!-- Logo / Brand -->
            <a href="#" class="flex items-center gap-3 font-bold text-xl text-indigo-600">
...
<footer class="bg-white border-t border-gray-200 mt-auto">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <div class="flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-gray-600">
            <div>
                © {{ date('Y') }} <span class="font-medium text-gray-900">Admin Panel</span>. Все права защищены.
            </div>
            <div class="flex gap-6">
                <a href="#" class="hover:text-indigo-600 transition">Документация</a>
                <a href="#" class="hover:text-indigo-600 transition">Поддержка</a>
                <a href="#" class="hover:text-indigo-600 transition">О проекте</a>
            </div>
        </div>
    </div>
</footer>
